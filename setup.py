...
def read_version():
    p = os.path.join(os.path.abspath(os.path.dirname(__file__)),'pyyingyu','version.py')
    with open(p,'rb') as f:
...
def main():
    ...
    setup(
        ...
        url='http://github.com/xiaoslzhang/pyyingyu',
        ...
        entry_points={
            'console_scripts':['pyyingyu = pyyingyu.cli:main']    
        },
